  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-clip-text py-4 text-center font-medium text-4xl tracking-tight md:text-7xl"
      >
        Astro Template
      </motion.h1>
      <motion.p
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        'relative z-0 flex min-h-[600px] w-full flex-col items-center justify-center overflow-hidden rounded-md bg-slate-950',
        className,
      )}
    >
